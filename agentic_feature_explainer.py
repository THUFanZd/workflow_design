...
class AgentBrain:
    ...
    def propose_hypotheses(
        ...
        user_prompt = (
            ...
            "- Description should be precise, not generic. If possible, just one sentence. No more than 30 words.\n"
            ...
            "- input-side/output-side feature description: observation-based description, each no more than 30 words each.\n"
